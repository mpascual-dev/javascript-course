...
function demonstrateLiveReload() {
  ...
  liveServerTest = 'Updated message - change #2';
  console.log('Updated variable inside function:', liveServerTest);
...
const maxNumber = Math.max(3, 7, 2, 10, 5);
console.log('The largest number is:', maxNumber);

// Example with an array (needs spread operator)
const numbers = [3, 11, 2, 10, 5];
const maxFromArray = Math.max(...numbers);
console.log('The largest number from the array is:', maxFromArray);
...
// Test 1 - Array of normal numbers
const normalScores1 = [85, 92, 78, 96, 88];
const normalResult1 = calculateAverageScoreFixed(normalScores1);
console.log('Test 1 (Normal scores):', normalResult1);

// Test 2 - Numbers mixed with bad data numbers
const mixedScores1 = [85, 'invalid', 92, null, 78];
const mixedResult1 = calculateAverageScoreFixed(mixedScores1);
console.log('Test 2 (Mixed data, bad values ignored):', mixedResult1);

// Test 3 - Wrong type of input
const errorResult1 = calculateAverageScoreFixed('not an array');
console.log('Test 3 (Wrong input type):', errorResult1);

// Test 4 - Empty list
const emptyResult1 = calculateAverageScoreFixed([]);
console.log('Test 4 (Empty array):', emptyResult1);
...
//   // Starting with an empty string we can add to
//   let str = "";

//   // each temp in the array
//   for (let i = 0; i < arr.length; i++) {

//     const dayLabel = i + 1 === 1 ? "day" : "days";

//     // Addin this temperature’s forecast string
//     str += `${arr[i]}°C in ${i + 1} ${dayLabel}...`;
//   }
...
// printForecast(data2);
// // Expected: ...12°C in 1 day...5°C in 2 days...-5°C in 3 days...0°C in 4 days...4°C in 5 days...
...
////////////////////////////////////
// RAPID INTERVIEW PRACTICE: Work Hours Breakdown

// function analyzeWorkWeek(dailyHours) {
//   // 1) calculated hours worked in total
//   const totalHours = dailyHours.reduce((sum, hours) => sum + hours, 0);

//   // 2) Compute the average with rounding
//   const averageHours = Math.round((totalHours / dailyHours.length) * 10) / 10;

//   // 3) max hours and which day
//   const maxHours = Math.max(...dailyHours);
//   const busiestIndex = dailyHours.indexOf(maxHours);
//   const weekdays = [
//     "Monday",
//     "Tuesday",
//     "Wednesday",
...
//     "Sunday",
//   ];
//   const busiestDay = weekdays[busiestIndex];

//   // 4) Count how many days had >0 hours
//   const daysWorked = dailyHours.filter(h => h > 0).length;

//   // 5) Decide if it qualifies as full-time (35+ hours total)
//   const isFullTime = totalHours >= 35;

//   // Return results in a clear object
//   return {
//     totalHours,
//     averageHours,
//     busiestDay,
